...
export default function TimeTableDayItem({
  ...
  return (
    <Card className="mx-[2px] gap-0 w-[calc(100%-2px)] xl:w-[calc(20%-4px)] lg:w-[calc(33.333%-4px)] md:w-[calc(50%-4px)] sm:w-[calc(100%-2px)] h-full overflow-hidden shrink-0 grow-0 py-1 px-0 snap-start scroll-ml-1">
